...
export const _getInitiativeFormula = function(combatant) {
  ...
  if (actor.getFlag("dndestiny", "halflingLucky")) mods += "r=1";
  if (actor.getFlag("dndestiny", "initiativeAdv")) {
    nd = 2;
    mods += "kh";
  }
